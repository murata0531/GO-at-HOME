            ...
            <div class="main row">
                ...
                <div class="box2 col-3 p-0">
                    ...
                    <div class="menu">
                        ...
                        @else
                        <li><a href="/home/private?privateid={{$e->user_id}}&privatename={{$e->name}}&privateicon={{$e->user_icon}}">{{$e->name . "(" . $e->tuzukigara_name . ")"}}<small>{{"【前回のログイン : " . date('Y年m月d日H時i分',  strtotime($e->final_login)) . "】　"}}</small></a></li>
                        @endif
                        @endforeach
                        </ul>
